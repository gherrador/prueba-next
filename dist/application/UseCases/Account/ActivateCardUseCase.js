...
exports.ActivateCardUseCase = void 0;
...
class ActivateCardUseCase {
    ...
    run(iban) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (userData.cardActivated === true)
                throw new Error("Card already activate");
            const usernameLogin = yield this._accountRepository.cardActivated(userData.IBAN);
            return usernameLogin;
        });
    }
}
exports.ActivateCardUseCase = ActivateCardUseCase;
